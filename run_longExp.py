...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, required=False, default='LSM',
                        help='model name, options: [LSM]')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_n1{}_n2{}_n3{}_dr{}_cin{}_rin{}_res{}_dst{}_dconv{}_efact{}'.format(
                args.model_id,
                args.model,
                args.model_id_name,
                args.features,
